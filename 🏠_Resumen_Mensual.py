...
# (Omitidos por brevedad, son los mismos que ya teníamos)
...
# ----------------------------------------------------
    ...
    # --- INICIO DE LA NUEVA SECCIÓN DE ANÁLISIS DETALLADO CON TABS ---
    st.markdown("---")
    ...
    with tab1:
        st.subheader("Análisis de Marcas y Marquillas Clave")
