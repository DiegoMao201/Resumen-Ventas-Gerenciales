...
def render_dashboard():
    ...
    # Determinar el año y mes más recientes disponibles en TODO el dataset
    ...
    # Se ajusta el mes por defecto para que sea el más reciente si se selecciona el año más reciente
